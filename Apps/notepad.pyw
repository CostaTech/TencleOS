...
class TextEditor:
  ...
  def __init__(self,root):
    ...
    # Initializing Status
    self.status.set("Welcome To Tencle-Pad")
    # Creating Menubar
  ...
  def infoabout(self):
    messagebox.showinfo("About Text Editor","Tencle-Pad is a simple text editor included with the Tencle-OS")
