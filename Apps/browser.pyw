...
class MainWindow(QMainWindow):
    def __init__(self, *args, **kwargs):
        ...
        about_action = QAction(QIcon(os.path.join('images', 'question.png')), "About Tencle-Browser", self)
        about_action.setStatusTip("Find out more about Tencle-Browser")  # Hungry!
    ...
    def update_title(self):
        ...
        self.setWindowTitle("%s - Tencle-Browser" % title)
...
app.setApplicationName("Tencle-Browser")
app.setOrganizationName("Tencle")
